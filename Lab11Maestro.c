 ...
 * Author: jorge
 *
 * Created on 10 de mayo de 2022, 08:44 PM
 */
// CONFIG1
...
void setup(void){
    ...
    TRISA = 0b00100001;         // RA0, RA5 como entradas
    TRISC = 0b00010000;         // SD1 entrada, SCK y SD0 como salida
    TRISD = 0;                  // POTC como salida
...
void main(void) {
    ...
    while(1){
        ...
        PORTAbits.RA7 = 1;      // Deshabilitar el SS del esclavo
        __delay_ms(10);         // Delay para detectar el cambio de pin
        PORTAbits.RA7 = 0;      // Se hailita nuevamente el esclavo
